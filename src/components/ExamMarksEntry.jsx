        ...
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
          ...
          <div className="p-3 bg-gray-50 border-t border-gray-200 flex justify-end">
            <button 
              ...
              disabled={loading}
              className="px-6 py-2 bg-emerald-600 text-white text-xs font-bold rounded-xl hover:bg-emerald-700 transition flex items-center gap-2"
            >
              <Save className="w-4 h-4" /> {loading ? 'Saving...' : 'Save Marks'}
            </button>
          </div>
        </div>
      )}
