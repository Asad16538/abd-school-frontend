    ...
    <div className="fixed inset-0 bg-black/90 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl p-4 max-w-md w-full">
        <div className="flex justify-between items-center mb-4">
          ...
          <button onClick={onClose} className="text-gray-500 font-bold text-xl hover:text-gray-700">✕</button>
        </div>
        ...
        {error && (
          <div className="mt-3">
            <p className="text-red-600 text-sm font-bold text-center">⚠️ {error}</p>
            <button onClick={startCamera} className="w-full mt-2 py-2 bg-indigo-600 text-white text-xs font-bold rounded-lg">
              🔄 Retry
            </button>
          </div>
        )}
