...
// ✅ YAHAN ADD KARO - Dusre imports ke saath
...
const StaffApp = () => {
  ...
  const [showExamMarks, setShowExamMarks] = useState(false);
    ...
    <div className="min-h-screen bg-gray-50 font-sans pb-20">
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 flex justify-around p-2 z-50 shadow-lg">
        ...
        <button 
          ...
          className={`flex flex-col items-center p-2 rounded-lg ${activeTab === 'exam_marks' ? 'text-indigo-600 bg-indigo-50' : 'text-gray-500'}`}
        >
          <FileText className="w-5 h-5" />
          <span className="text-[9px] font-bold">मार्क्स</span>
        </button>
        <button 
