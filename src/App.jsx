                              ...
                              <tr key={st.id} className="hover:bg-slate-50/60 transition-all">
                                ...
                                <td className="p-3">
                                  <div className="flex items-center justify-center gap-2">
                                    ...
                                    <button onClick={() => sendFeeReminder(st)} className="px-3 py-2 bg-amber-400 text-black font-black text-[10px] uppercase tracking-wider rounded-xl shadow-sm cursor-pointer hover:bg-amber-500 transition-all">🔔 याद दिलाएं (WhatsApp)</button>
                                  </div>
                                </td>
                              </tr>
                            ))}
